...
class RegistrationControlsTexts(Enum):
    ...
    INVALID_PARTNER_CODE = 'Partner code is invalid. Click “Continue” to register without a partner code.'
    NOT_US_RESIDENT = 'For regulatory reasons, we do not accept citizens or residents of the United States'
